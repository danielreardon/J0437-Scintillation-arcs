...
Repository containing data and code used for the analysis of scintillation arcs in MeerKAT observations of J0437-4715 (Reardon et al., submitted).

The data provided are the normalise secondary spectra (Hough transform) forms, to reduce file size. The large raw dynamic spectra will be made available for download elsewhere, and a link provided here.
...
![](https://github.com/danielreardon/J0437-Scintillation-arcs/blob/main/plot/model_animation.gif?raw=true)
